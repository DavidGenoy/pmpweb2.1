      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <h2 className="font-organic text-5xl text-white mb-6">A holistic approach to your health.</h2>
            <p className="font-organic text-xl text-white/60">We offer a wide range of services designed to keep you and your family thriving at every stage of life.</p>
          </div>
          <a href="#services" className="font-organic text-lg text-v2-olive underline underline-offset-8">View all services</a>
        </div>
